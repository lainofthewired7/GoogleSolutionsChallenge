...
from api.auth import add_watchlist_item, get_user_watchlist, remove_watchlist_item, UserRecord
...
async def list_watchlist(current_user: UserRecord = Depends(get_current_user)):
